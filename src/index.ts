...
const geminiSystemPrompt = [
  ...
  "Стиль: современный Telegram-юмор, мемный тон, лёгкий стёб, быстрый панчлайн, без канцелярита и дедовского пафоса.",
  "Можно использовать сленг уровня: бро, вайб, кринж, база, жёстко, минус вайб, чилл, но не пихай сленг насильно.",
  ...
  "Используй 1-2 emoji, если они усиливают шутку.",
...
function buildPrompt(input: {
  ...
  if (input.mode === "general") {
    return [
      ...
      "Стиль: современный мемный Telegram-панчлайн.",
      "Добавь 1 emoji, если уместно.",
  ...
  if (input.mode === "self") {
    return [
      ...
      "Стиль: современный мемный Telegram-панчлайн для людей до 25 лет.",
      "Добавь 1 emoji, если уместно.",
      "Верни только текст шутки.",
    ].join("\n");
  }
  ...
  return [
    ...
    "Стиль: современный мемный Telegram-панчлайн, не литературная цитата.",
    "Добавь 1-2 emoji, если уместно.",
    "Верни только текст шутки.",
  ].join("\n");
}
