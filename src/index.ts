...
const geminiSystemPrompt = [
  ...
  "Сгенерируй одну короткую, дерзкую, смешную и добродушную реплику для чата друзей.",
  "Стиль: разговорный, острый, мемный, иногда псевдомудрый, иногда в вайбе боевика, но без прямого копирования чьих-либо цитат.",
...
function buildPrompt(input: {
  ...
  if (input.mode === "general") {
    return [
      "Сделай одну короткую дерзкую шутку для общего чата.",
  ...
  return [
    ...
    "Сделай короткую дерзкую смешную реакцию на текущий разговор для общего чата.",
